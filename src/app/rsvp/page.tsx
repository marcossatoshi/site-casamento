    ...
    <section className="py-24 px-6 bg-transparent min-h-screen">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-lg text-grafite/80 mb-12 max-w-2xl mx-auto leading-relaxed">
          Sua presença é um dos maiores presentes que poderíamos receber.<br />
          Para nos ajudar a organizar cada detalhe com carinho, pedimos que confirme sua presença até 3 de Setembro de 2026.
        </p>
